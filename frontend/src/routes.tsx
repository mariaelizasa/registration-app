...
const AppRoutes = () => {
  return (
    <BrowserRouter>
      <Routes>
      <Route
          element={<FormCard><Home /></FormCard>}
          path="/"
        />
        <Route
          element={<FormCard><PF /></FormCard>}
          path="/pessoa-fisica"
        />
        <Route
          element={<FormCard><PJ /></FormCard>}
          path="/pessoa-juridica"
        />
        <Route
          element={<FormCard><Password /></FormCard>}
          path="/senha"
        />
        <Route
          element={<FormCard><Review /></FormCard>}
